...
export function freshness(updatedAt, now, halfLifeDays = 120) {
...
export function usageBoost(successAfterRecall, failAfterRecall) {
 ...
 */
export function frequencyBoost(timesSeen) {
 ...
 */
export function recallBoost(timesRecalled) {
 ...
 */
export function lexicalBoost(record, terms) {
...
export function scoreRecord(record, options = {}) {
...
export function rankRecords(records, options = {}) {
    return records
...
export function fitBudget(ranked, render, options) {
    const selected = [];
    let tokensUsed = 0;
    let dropped = 0;
